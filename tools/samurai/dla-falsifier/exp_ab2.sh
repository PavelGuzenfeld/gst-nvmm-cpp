...
echo; echo "############ B: yolo26n on DLA core 1 (onnx fixed 1x3x576x1920) ############"
$T --onnx=/y/yolo26n.onnx --useDLACore=1 --fp16 --allowGPUFallback \
...
echo; echo "############ B-ref: same yolo26n on GPU @576x1920 (apples-to-apples) ############"
$T --onnx=/y/yolo26n.onnx --fp16 --saveEngine=$OUT/yolo_gpu576.engine \
